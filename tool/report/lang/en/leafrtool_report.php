...
/**
 * English strings for leafrtool_report.
 *
...
$string['privacy:metadata'] = 'The overview page only displays data already stored by mod_leafr and its other tools (e.g. reading progress, read confirmations); it does not collect or store anything of its own.';
$string['reportcompleted'] = 'Completed';
$string['reportconfirmedat'] = 'Confirmed on';
