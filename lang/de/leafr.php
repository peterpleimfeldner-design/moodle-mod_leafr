...
$string['bookmark_note_saved'] = 'Gespeichert';
...
$string['chaptersintro'] = 'Eine Zeile pro Kapitel: Titel und Startseite. Wird für den Reiter „Inhalt“ verwendet, wenn das PDF kein eigenes Inhaltsverzeichnis hat, oder immer, wenn oben „Immer die manuelle Liste verwenden“ aktiviert ist. Tipp: Aus Word oder PowerPoint exportierte PDFs enthalten meist automatisch ein Inhaltsverzeichnis, wenn die Überschriften mit Formatvorlagen für Überschriften gestaltet sind und beim Export die Option zum Erstellen von Lesezeichen aus Überschriften aktiviert ist – dann ist diese manuelle Liste meist nicht nötig.';
...
$string['completionchapters_help'] = 'Ausgewählte Kapitel werden beim Speichern zu den „Pflichtseiten“ oben hinzugefügt. Es werden nur Kapitel angezeigt, die im Abschnitt „Kapitel“ bereits gespeichert sind.';
...
$string['error_invalidpagerange'] = 'Bitte geben Sie gültige Seitenzahlen oder -bereiche ein, z. B. „1-5, 8, 12-20“, oder wählen Sie mindestens ein Kapitel aus.';
...
$string['gotopage'] = 'Zu Seite springen';
$string['help'] = 'Tastaturkürzel';
$string['help_bookmark'] = 'Lesezeichen der aktuellen Seite setzen oder entfernen';
$string['help_close'] = 'Dialog oder Seitenleiste schließen, Vollbild verlassen';
$string['help_firstlast'] = 'Erste oder letzte Seite';
$string['help_fullscreen'] = 'Vollbild ein- oder ausschalten';
$string['help_help'] = 'Diese Hilfe anzeigen';
$string['help_intro'] = 'Die Tastaturkürzel funktionieren, sobald Sie in das Dokument geklickt haben.';
$string['help_nextprev'] = 'Nächste oder vorherige Seite';
$string['help_toc'] = 'Inhaltsverzeichnis ein- oder ausblenden';
...
$string['modulename_help'] = 'Das Leafr-Flipbook zeigt ein PDF-Dokument als Buch, in dem Teilnehmer/innen direkt im Kurs blättern – mit einer realistischen Blätteranimation.

Beim nächsten Öffnen geht es an der zuletzt gelesenen Seite weiter. Der Text lässt sich durchsuchen, Kapitel sind über das Inhaltsverzeichnis oder die Seitenminiaturen erreichbar, und Lesezeichen können mit persönlichen Notizen versehen werden.

Die Aktivität kann automatisch abgeschlossen werden, wenn die letzte Seite, ein bestimmter Prozentsatz der Seiten, eine bestimmte Seite oder ausgewählte Seiten und Kapitel angesehen wurden; zusätzlich kann eine Lesebestätigung verlangt werden. Für Barrierefreiheit gibt es eine einfache, scrollbare Ansicht ohne Blätteranimation.';
...
$string['search_hint'] = 'Suchbegriff eingeben und Enter drücken.';
...
$string['showtoc_help'] = 'Zeigt die im PDF gespeicherte Gliederung (in PDF-Programmen oft „Lesezeichen“ genannt) im Reiter „Inhalt“ der Seitenleiste an. Hat das PDF keine Gliederung, werden die im Abschnitt „Kapitel“ angelegten Kapitel verwendet.';
...
$string['subplugintype_leafrtool'] = 'Leafr-Werkzeug';
$string['subplugintype_leafrtool_plural'] = 'Leafr-Werkzeuge';
$string['tab_bookmarks'] = 'Lesezeichen';
$string['tab_contents'] = 'Inhalt';
$string['tab_search'] = 'Suche';
$string['tab_thumbnails'] = 'Miniaturen';
$string['thumbs_legend_required'] = 'Pflichtseite';
$string['thumbs_legend_seen'] = 'Gelesen';
$string['toc_empty'] = 'Dieses PDF enthält kein Inhaltsverzeichnis.';
$string['toolbar'] = 'Flipbook-Steuerung';
